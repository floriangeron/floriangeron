                ...
                <div className="grid md:grid-cols-4 gap-8">
                    <main className={`md:col-span-3 text-gray-800 ${fontSizeClass} max-w-[min(100%,65ch)] mx-auto md:max-w-none md:mx-0 px-4`}>
                        ...
                        <CollapsibleReview title="Manda de Laos" rating={5} scale="food">
                            ...
                            The outdoor area of the restaurant straddles a large lily pond, making for a unique and romantic atmosphere. The food was delicious, adding a modern twist to Lao dishes and a Lao twist to international dishes. Francesca ordered a Laojito, which was a mojito with lemongrass. This ended up being our favorite cocktail of the entire trip! Florian ordered a dragonfruit cocktail, which clearly fancies itself as the queen of cocktails.<br/>
                        ...
                        We reached the top of the mountain a solid 45 minutes before sunset, which made for a great time to take some pictures. The queue for the first bike was doable, and the second one wasn't too bad either, up until the couple in front of us had their turn. They spent a solid 10 minutes on their pictures, and we suspect they were waiting for the sunset to actually happen. At a certain point the wait became ridiculous, at which point the other people in the queue told them it was time to move on. This was an awkward situation, but this meant that we actually had one of the best times of day for our photoshoot! It did mean we felt pretty rushed though.<br/>
                        ...
                        <h4 id="vang-vieng-day-2" className="text-xl font-bold mb-4">Ziplining and Kayaking </h4>
                        ...
                        After the ziplining, the tour operators drove us to the river where we would do some kayaking. The kayaking was pretty fun, but the highlight was towards the end of the trip, as we made our way back into the city. As the sun was going down, the hot air balloons and paramotors were taking off all around us, making for an unforgettable view and experience.<br/><br/>
                        <div className="grid md:grid-cols-2 gap-2">
                            <figure className="md:col-span-1">
                                <img
                        ...
                        <CollapsibleReview title="Mama very big" rating={5} scale="hotdog">
                            This street vendor has obtained a legendary status in Vang Vieng. She serves a kind of hotdog, heavi(n)ly loaded with toppings such as avocado, egg, cheese, and sauces. The resulting hotdog is as delicious as it is filling. We took one each on one of our adventures to picnic at the blue lagoon 2, and it was the perfect lunch meal, loading us up with enough calories to last us through the day.
                            <br />
                            ...
                            <div className="grid md:grid-cols-2 gap-2">
                                ...
                                <figure className="md:col-span-1">
                                    ...
                                    />
                                    <figcaption className="text-center text-sm text-gray-600">Enjoying the sandwich at Blue Lagoon 2</figcaption><br/>
                                </figure>
                            </div>
