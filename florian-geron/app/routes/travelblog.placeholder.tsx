...
export const meta: MetaFunction = () => {
  return [
    { title: "Destination Travel Blog" },
    { name: "My personal website", content: "My Destination Travel Blog" },
    { description: "Travel blog about destination." },
  ];
};
            ...
            <div className="relative h-[350px] sm:h-[450px] md:h-[700px] w-full overflow-hidden">
                ...
                <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
                    <div className="text-center text-white">
                        <h1 className="text-6xl font-bold mb-4">Destination</h1>
                        <p className="text-2xl">Sunsets and Adventure in Destination</p>
                    </div>
                </div>
            ...
            <div className="max-w-7xl mx-auto py-12 px-4">
                ...
                <div className="grid md:grid-cols-4 gap-8">
                    <main className={`md:col-span-3 text-gray-800 ${fontSizeClass} max-w-[min(100%,65ch)] mx-auto md:max-w-none md:mx-0 px-4`}>
                        ...
                        {/* Luang Prabang */}
                        <h2 id="destination-1" className="text-4xl font-bold mb-4">Destination 1</h2>

                        {/* Vang Vieng */}
                        <h2 id="destination-2" className="text-4xl font-bold mb-4">Destination 2</h2>
                    ...
                    <aside className="hidden md:block md:col-span-1">
                        ...
                        <nav aria-label="Table of contents" className="sticky top-8 self-start bg-white/90 dark:bg-gray-900/80 text-right p-4 hover:scale-105 transition-transform duration-300 overflow-auto">
                            ...
                            <ul className="space-y-2 text-sm text-gray-700">
                                ...
                                <li>
                                    <a href="#destination-1" onClick={(e) => handleTocClick(e, 'destination-1')} className="block w-full text-left pl-20 font-bold hover:underline">Destination 1</a>
                                </li>
                                <li>
                                    <a href="#destination-2" onClick={(e) => handleTocClick(e, 'destination-2')} className="block w-full text-left pl-20 font-bold hover:underline">Destination 2</a>
                                </li>
                            </ul>
                        </nav>
