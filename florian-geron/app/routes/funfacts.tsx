...
const funfacts = [
    ...
    "Bhutan does not measure gross domestic product (GDP). Instead, they measure gross domestic happiness :)",
    ...
    "The Dutch language is littered with English loanwords. English contains some Dutch loanwords too, but most of these actually entered the English lexicon via Afrikaans, a language spoken in South-Africa. The most famous example is 'apartheid', meaning 'separate-ness'. Other examples include 'veldt' (field) and 'aardvark' (earth pig).",
