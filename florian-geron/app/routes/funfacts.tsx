...
const funfacts = [
    "The Vatican classifies capybara as fish. This allows Latin Americans to eat the animal during Lent.",
    ...
    "Chess is known as 'schaak' in Dutch and 'Schach' in German. These names all derive from the  Persian word for king, 'Shah'. The word 'checkmate' comes from Persian too, meaning 'the king is dead'.",
    ...
    "Normandy, the region in France, was given to a group of vikings by the French king. The vikings had nearly sacked Paris. The king was so impressed by their nack for warfare, that - despite the aggression - he gave them a piece of land along the French coast. In return, the vikings would protect France from any other seaborn invaders. This region came to be known as the region of the Northmen, i.e. Normandy.",
    "The croissant is a crescant-shaped pastry. In contemporary culture, it is associated with the French cuisine, but it orginated in Austria, whose inhabitants called it 'kipferl'. This is why the French refer to certain baked goods as 'Viennoiserie'. It is said the Viennese came up with the design after successfully repelling the Ottoman siege of Vienna of 1683: The flags of the fleeing Ottoman army, which contain a crescent moon, inspired Viennese bakers. In reality, the kipferl predates this battle.",
    "The mannequin is a lifelike doll used to try out clothes. Due to it French sound, it is associated with French haute-couture. However, it derives from the Flemish word 'manneken', meaning 'little man'. The mannequin gained popularity in the Flemish textile industry. The French, who either ruled or heavily influenced Flanders for most of its history, borrowed the word and changed its spelling and pronunciation. Most of the world now uses the French word, which has even found its way back into the Flemish vocabulary, displacing the original Flemish spelling and pronunciation."
