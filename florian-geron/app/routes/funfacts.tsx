...
const funfacts = [
    ...
    "Seven babies have been born in Antarctica, all of whom survived birth. This means that Antarctica has the lowest infant mortality rate of any continent.",
    ...
    "Great Britain used to be just called Britain.\nWhen the Germanic Anglo-Saxons invaded the island after the fall of the Western Roman Empire, some of its Celtic inhabitants moved back to mainland Europe (which they had originally fled to escape the Romans). They settled in a part of modern France. To disambiguate between the two places, the island became known as Great Britain and the French peninsula as Lesser Britain, now Brittany in English.",
    "Pink does not appear in the rainbow. Contrary to red or blue, pink cannot be created by changing the wavelength of light. Instead, pink is obtained by mixing different wavelengths. Concretely, pink is what you see when you subtract green from white light.",
    ...
    // 40
    "East-Timor is a country in Southeast Asia. The word 'Timor' means 'East'. This means that the country is called 'East-East'.",
    ...
    "Tuvalu's domain name is .tv. Thanks to this domain name's popularity, slightly under 10% of government revenue is generated by royalties coming from this domain name.\n\nSimilarly profitable domain names include Anguilla's (.ai), Micronesia's (.fm), and Djibouti's (.dj).\n\nYouTube uses Belgium's domain name when they shorten their URLs to youtu.be.",
    ...
    "The Milky Way is the name of our galaxy. In fact, all galaxies are named after milk: The word 'galaxy' comes from the Greek word 'gala', meaning milk. The words 'lactose' and 'lactic' come from the related Latin version of the root word, 'lac'.",
    ...
    "The EU's southernmost capital - Valletta of Malta - lies to the south of several African capitals, i.e. Algiers and Tunis.",
    ...
    "Yemen's GDP in 2023 was $17B.\nThis is less than Apple's revenue from selling AirPods that year, which was around $18B.",
    ...
    "Iceland has a relatively small population of less than 400 thousand people. Iceland has an application, connected to the national genealogy database, that has a feature that allows you to check how closely related you are to another person. This is widely used to avoid dating close relatives.",
    ...
    "The modern tie traces its origins back to the 17th century, during the Thirty Years' War, when Croatian mercenaries wore a piece of cloth around their necks as part of their military uniform. This fashion was adopted by the French, notably the French courts under Louis XIII and Louis XIV, who called it 'cravate', derived from 'Croat'. Over time, this evolved into the necktie we know today.",
    "The Chinese word 马马虎虎 (mǎmǎhūhū) literally translates to 'horse horse tiger tiger'. It is used to describe something done carelessly or mediocrely, similar to the English expression 'so-so'.\nThe phrase is believed to have originated from a story about an artist who painted an animal, but due to his carelessness, people couldn't tell if it was a horse or a tiger, leading to the expression.",
    "In Chinese, the words for four (the number) and death are pronounced similarly. This has led to the number four being considered unlucky in Chinese culture, similar to how the number thirteen is viewed in Western cultures. Many buildings in China skip the fourth floor, labeling it as '3A' or '5' instead.\nThis phenomenon is called tetraphobia.",
    // 140
    "Portuguese is the most widely spoken language in the Southern hemisphere.",
    "In Australia, there are native Aboriginal languages (such as Kuuk Thaayorre) that use cardinal directions (north, south, east, west) instead of relative directions (left, right, forward, backward). For example, speakers might describe an object as being 'to the north' rather than 'to the left'. Due to this linguistic particularity, speakers of these languages have an exceptional sense of direction and spatial awareness, always knowing their orientation relative to the cardinal directions.",
    "In the 1992 UEFA European Championship, Denmark won the tournament despite not originally qualifying.\nThey were called up last-minute to replace Yugoslavia, which was disqualified due to the ongoing Yugoslav Wars. Some Danish players were on vacation and had to be called back to join the team.",
    "The word 'robot' comes from the Czech word 'robota', which means 'forced labor'. It was first introduced to the public in 1921 by Czech writer Karel Čapek in his play 'R.U.R.' (Rossum's Universal Robots). The play depicted artificial people called robots, who were created to serve humans but eventually rebelled against their creators. These robots were not made of metal and silicon, but of organic matter, making them more similar to the replicants in Blade Runner than most robots of modern science fiction.",
    "Due to its location in the corner of most world maps, New Zealand is often overlooked or accidentally omitted.\nThe New Zealand government uses a version of the world map with the country missing on its 404 'Page not found' error page, as a humorous way to acknowledge this common oversight.",
    "The word petroleum comes from the Latin words 'petra' (rock) and 'oleum' (oil), meaning 'rock oil'.",
    "The name Indonesia comes from the Greek words Indos (Ἰνδός, 'Indian') and nesos (νῆσος, 'island'), meaning 'Indian islands'. Similarly, Polynesia means 'many islands', Micronesia means 'small islands', and Melanesia means 'black islands', a name historically given by Europeans in reference to the darker skin tone of many Indigenous inhabitants of the region.",
    "New Guinea is a fascinating island home to many indigenous peoples. In the 16th century, European explorers named the island 'New Guinea' because they thought the indigenous people resembled those in West Africa, a region known as Guinea to Europeans at the time.\nThe name Guinea continues to be used for several countries in West Africa, including Guinea (formerly French Guinea), Guinea-Bissau (formerly Portuguese Guinea), and Equatorial Guinea (formerly Spanish Guinea).",
    "China is about as wide east-to-west as the contiguous United States. Although the contiguous US runs on four separate time zones, China only uses one: Beijing Time. If you are in Beijing, this is fine.\n\nIn the far Western province of Xinjiang, home to the Uyghurs, this brings some challenges. In winter, the sun rises after 10 am. In response, the local population (mainly the Uyghurs) uses a second, unofficial local time, which is used informally in everyday life.\n\nChina only having one time zone results in a particularly striking situation at the border with Afghanistan. There is a time difference of 3 and a half hours across this border, the largest official time difference at any land border on Earth.",
    "The American Civil War was the deadliest conflict in American history. In fact, more Americans died during the Civil War than during all other U.S. wars combined, including the War of Independence, World War I, World War II, and the Vietnam War.",
    //150
